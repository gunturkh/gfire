...
const Base = () => {
  ...
  const [places, _] = useState([
    ...
    },
    {
      ...
      city: 'Hongkong',
      color: '#00398D',
      coordinates: [22.3527234, 114.1394, 10],
      lat: 22.3527234,
      lng: 114.1394,
      size: 50,
    },
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed max-h-[100vh] w-[40px] h-[200px] md:w-[60px] md:h-[550px] bg-[#FFF] top-[120px] flex flex-col justify-evenly py-[100px] rounded-tr-3xl rounded-br-3xl shadow drop-shadow-md z-50`}
      >
        <a
          href="https://www.facebook.com/profile.php?id=100009128238323"
          target="_blank"
          rel="noreferrer"
        >
          <img
        ...
        <a
          href="http://www.linkedin.com/in/gfire-asia-1a50a7288"
          target="_blank"
          rel="noreferrer"
        >
          <img
      ...
      {/* <div className="absolute right-0">
        <div className="bg-[#003FB7] rounded-sm p-4">Hongkong</div>
        <img
          src={'/assets/images/asiapacific.png'}
          alt="Globe"
        />
      </div> */}
      {/* @ts-ignore */}
      <SizeMe monitorHeight monitorWidth>
        {({ size: { width } }) => (
          ...
          >
            <Globe
              ref={globeEl}
              // onGlobeClick={(e) => console.log('globe', e)}
              onGlobeReady={() => {
                const MAP_CENTER = {
                  lat: -0.665601,
                  lng: 104.961116,
              ...
              globeImageUrl="/assets/images/earth-red-white.jpeg"
              ...
              htmlElement={(d: any) => {
                ...
                el.innerHTML = `
              <div class='relative right-[-10px] top-[-10px]'>
                <div class='hover:bg-[#820100] hover:text-white bg-[#00398D] fixed top-[-25px] left-[-100px] py-2 px-4 font-bold rounded-tl-xl rounded-bl-xl rounded-tr-xl'>${d.city}</div>
                <div class=''>${markerSvg}</div>
              </div>`;
